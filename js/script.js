document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateTabsArrow() {
    if (!menuTabs) return;
    const atEnd =
      menuTabs.scrollLeft + menuTabs.clientWidth >= menuTabs.scrollWidth - 4;
  ...
  document
    .getElementById("btn-impressum")
    ?.addEventListener("click", () => openModal("modal-impressum"));
  document
    .getElementById("btn-datenschutz")
    ?.addEventListener("click", () => openModal("modal-datenschutz"));
  ...
  document
    .getElementById("event-popup-skip")
    ?.addEventListener("click", closeEventPopup);
